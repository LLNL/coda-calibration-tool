...
public class WrappingEventHandler<T> implements EventHandler<javafx.scene.control.TableColumn.CellEditEvent<T, java.lang.String>> {

    private EventHandler<CellEditEvent<T, String>> existingHandler;
    private BiConsumer<T, Double> setValue;

    public WrappingEventHandler(EventHandler<CellEditEvent<T, String>> existingHandler, BiConsumer<T, Double> setValue) {
