...
public class EnvelopeJsonController {
    ...
    public ResponseEntity<?> createBatch(@PathVariable Long sessionId, @Valid @RequestBody EnvelopeJob job, BindingResult bindResult) {
        ...
        Result<List<Waveform>> result = service.createEnvelopes(sessionId, job.getData(), job.getJobConfig(), false);
    ...
    public ResponseEntity<?> createBatchStacks(@PathVariable Long sessionId, @Valid @RequestBody EnvelopeJob job, BindingResult bindResult) {
        ...
        Result<List<Waveform>> result = service.createEnvelopes(sessionId, job.getData(), job.getJobConfig(), true);
