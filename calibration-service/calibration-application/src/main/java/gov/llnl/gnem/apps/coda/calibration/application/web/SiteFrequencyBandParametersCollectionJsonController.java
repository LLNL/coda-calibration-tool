...
public class SiteFrequencyBandParametersCollectionJsonController {
    ...
    public ResponseEntity<?> create(@Valid @RequestBody SiteFrequencyBandParameters siteFrequencyBandParameters, BindingResult result) {
        ...
        UriComponents showURI = SiteFrequencyBandParametersItemJsonController.showURI(newSiteFrequencyBandParameters);

        return ResponseEntity.created(showURI.toUri()).build();
    }

    @PostMapping(value = "/batch", name = "createBatch")
    public ResponseEntity<?> createBatch(@Valid @RequestBody Collection<SiteFrequencyBandParameters> siteFrequencyBandParameters, BindingResult result) {
