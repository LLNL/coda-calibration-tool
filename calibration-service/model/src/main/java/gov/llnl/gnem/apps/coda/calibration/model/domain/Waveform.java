...
public class Waveform implements Serializable {
    ...
    public String toString() {
        return "Waveform [id=" + id + ", version=" + version + ", event=" + event + ", stream=" + stream + ", beginTime=" + beginTime + ", endTime=" + endTime + ", segmentType=" + segmentType
                + ", segmentUnits=" + segmentUnits + ", lowFrequency=" + lowFrequency + ", highFrequency=" + highFrequency + ", sampleRate=" + sampleRate + "]";
    }
