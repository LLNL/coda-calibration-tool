...
public class MdacParametersPS {
    ...
    public String toString() {
        return "MdacParametersPS [id=" + id + ", version=" + version + ", phase=" + phase + ", q0=" + q0 + ", delQ0=" + delQ0 + ", gamma0=" + gamma0 + ", delGamma0=" + delGamma0 + ", u0=" + u0
                + ", eta=" + eta + ", delEta=" + delEta + ", distCrit=" + distCrit + ", snr=" + snr + "]";
    }
