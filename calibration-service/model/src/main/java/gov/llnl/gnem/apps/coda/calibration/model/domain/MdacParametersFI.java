...
public class MdacParametersFI {
    ...
    public String toString() {
        return "MdacParametersFI [id=" + id + ", version=" + version + ", sigma=" + sigma + ", delSigma=" + delSigma + ", psi=" + psi + ", delPsi=" + delPsi + ", zeta=" + zeta + ", m0ref=" + m0ref
                + ", alphas=" + alphas + ", betas=" + betas + ", rhos=" + rhos + ", radPatP=" + radPatP + ", radPatS=" + radPatS + ", alphaR=" + alphaR + ", betaR=" + betaR + ", rhor=" + rhor + "]";
    }
