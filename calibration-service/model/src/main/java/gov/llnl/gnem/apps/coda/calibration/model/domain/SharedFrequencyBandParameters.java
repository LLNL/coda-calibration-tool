...
import gov.llnl.gnem.apps.coda.calibration.model.domain.util.Durable;
...
public class SharedFrequencyBandParameters {
    ...
    public String toString() {
        return "SharedFrequencyBandParameters [id=" + id + ", version=" + version + ", lowFrequency=" + getLowFrequency() + ", highFrequency=" + getHighFrequency() + ", velocity0=" + velocity0
                + ", velocity1=" + velocity1 + ", velocity2=" + velocity2 + ", beta0=" + beta0 + ", beta1=" + beta1 + ", beta2=" + beta2 + ", gamma0=" + gamma0 + ", gamma1=" + gamma1 + ", gamma2="
                + gamma2 + ", minSnr=" + minSnr + ", s1=" + s1 + ", s2=" + s2 + ", xc=" + xc + ", xt=" + xt + ", q=" + q + ", minLength=" + minLength + ", maxLength=" + maxLength
