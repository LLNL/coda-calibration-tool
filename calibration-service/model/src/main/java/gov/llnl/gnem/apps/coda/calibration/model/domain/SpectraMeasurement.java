...
public class SpectraMeasurement implements Serializable {
    ...
    public String toString() {
        return "SpectraMeasurement [id=" + id + ", version=" + version + ", waveform=" + waveform + ", rawAtStart=" + rawAtStart + ", rawAtMeasurementTime=" + rawAtMeasurementTime + ", pathCorrected="
                + pathCorrected + ", pathAndSiteCorrected=" + pathAndSiteCorrected + ", startCutSec=" + startCutSec + ", endCutSec=" + endCutSec + ", rmsFit=" + rmsFit + "]";
    }
