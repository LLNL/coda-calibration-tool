...
public interface SharedFrequencyBandParametersService extends BaseService<SharedFrequencyBandParameters, Long> {

    public List<FrequencyBand> getFrequencyBands();

    public SharedFrequencyBandParameters update(SharedFrequencyBandParameters sharedFbParams);
