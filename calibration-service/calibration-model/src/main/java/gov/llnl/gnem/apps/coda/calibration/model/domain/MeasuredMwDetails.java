...
public class MeasuredMwDetails {
	...
	public MeasuredMwDetails(MeasuredMwParameters meas, ReferenceMwParameters ref, ValidationMwParameters val,
			Event event) {
		if (meas != null) {
	...
	public String toString() {
		...
		builder.append(", mw=");
		builder.append(mw);
		builder.append(", totalEnergy=");
		builder.append(logTotalEnergy);
		builder.append(", totalEnergyMDAC=");
	...
	public int hashCode() {
		return Objects.hash(apparentStress1Max, apparentStress1Min, apparentStress2Max, apparentStress2Min,
				apparentStressInMpa, bandCoverage, cornerFreq, cornerFreqSd, dataCount, datetime, depth, eventId,
				iterations, latitude, longitude, misfit, mw, mw1Max, mw1Min, mw2Max, mw2Min, mwSd,
				refApparentStressInMpa, refMw, stationCount, logTotalEnergy, logTotalEnergyMDAC, valApparentStressInMpa,
				valMw);
	}
	...
	public boolean equals(Object obj) {
		...
		return Objects.equals(apparentStress1Max, other.apparentStress1Max)
				...
				&& Objects.equals(bandCoverage, other.bandCoverage) && Objects.equals(cornerFreq, other.cornerFreq)
				&& Objects.equals(cornerFreqSd, other.cornerFreqSd) && Objects.equals(dataCount, other.dataCount)
				&& Objects.equals(datetime, other.datetime) && Objects.equals(depth, other.depth)
				&& Objects.equals(eventId, other.eventId) && Objects.equals(iterations, other.iterations)
				&& Objects.equals(latitude, other.latitude) && Objects.equals(longitude, other.longitude)
				&& Objects.equals(misfit, other.misfit) && Objects.equals(mw, other.mw)
				...
				&& Objects.equals(refMw, other.refMw) && Objects.equals(stationCount, other.stationCount)
