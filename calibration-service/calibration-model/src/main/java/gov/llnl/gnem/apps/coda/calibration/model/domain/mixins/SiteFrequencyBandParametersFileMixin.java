...
@JsonIgnoreProperties(value = { "id", "version", "station" })
public class SiteFrequencyBandParametersFileMixin {
    ...
    @JsonProperty("lowFreqHz")
    public SiteFrequencyBandParametersFileMixin setLowFrequency(double lowFrequency) {
    ...
    @JsonProperty("highFreqHz")
    public SiteFrequencyBandParametersFileMixin setHighFrequency(double highFrequency) {
