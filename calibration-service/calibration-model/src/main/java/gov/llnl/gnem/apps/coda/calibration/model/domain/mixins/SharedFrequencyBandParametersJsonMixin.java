...
public class SharedFrequencyBandParametersJsonMixin {
    ...
    @JsonProperty("lowFreqHz")
    public SharedFrequencyBandParametersJsonMixin setLowFrequency(double lowFrequency) {
    ...
    @JsonProperty("highFreqHz")
    public SharedFrequencyBandParametersJsonMixin setHighFrequency(double highFrequency) {
    ...
    public SharedFrequencyBandParametersJsonMixin setMinSnr(double minSnr) {
        this.minSnr = minSnr;
        return this;
    }
    ...
    public SharedFrequencyBandParametersJsonMixin setMinLength(double minLength) {
    ...
    public SharedFrequencyBandParametersJsonMixin setMaxLength(double maxLength) {
    ...
    public SharedFrequencyBandParametersJsonMixin setMeasurementTime(double measurementTime) {
