...
@Transactional
public interface CalibrationSettingsRepository extends DetachableJpaRepository<CalibrationSettings, Long> {
    public CalibrationSettings findFirstByOrderById();
}
