...
@Transactional
public interface VelocityConfigurationRepository extends DetachableJpaRepository<VelocityConfiguration, Long> {
    public VelocityConfiguration findFirstByOrderById();
}
