...
@Transactional
public interface CalibrationShapeFitterConstraintsRepository extends DetachableJpaRepository<ShapeFitterConstraints, Long> {
    public ShapeFitterConstraints findFirstByOrderById();
}
