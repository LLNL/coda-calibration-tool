...
@JsonComponent
public class WaveformDeserializer extends JsonObjectDeserializer<Waveform> {

    private WaveformService waveformService;

    final ObjectReader mapper = new ObjectMapper().readerFor(Waveform.class);

    @Autowired
    public WaveformDeserializer(@Lazy WaveformService waveformService) {
    ...
    public Waveform deserializeObject(JsonParser jsonParser, DeserializationContext context, ObjectCodec codec, JsonNode tree) throws IOException {
