...
@JsonComponent
public class MdacParametersFiDeserializer extends JsonObjectDeserializer<MdacParametersFI> {

    private MdacParametersFiService mdacParametersService;

    final ObjectReader mapper = new ObjectMapper().readerFor(MdacParametersFI.class);

    @Autowired
    public MdacParametersFiDeserializer(@Lazy MdacParametersFiService mdacParametersService) {
    ...
    public MdacParametersFI deserializeObject(JsonParser jsonParser, DeserializationContext context, ObjectCodec codec, JsonNode tree) throws IOException {
