...
@JsonComponent
public class SharedFrequencyBandParametersDeserializer extends JsonObjectDeserializer<SharedFrequencyBandParameters> {

    private SharedFrequencyBandParametersService sharedFrequencyBandParametersService;

    final ObjectReader mapper = new ObjectMapper().readerFor(SharedFrequencyBandParameters.class);

    @Autowired
    public SharedFrequencyBandParametersDeserializer(@Lazy SharedFrequencyBandParametersService sharedFrequencyBandParametersService) {
    ...
    public SharedFrequencyBandParameters deserializeObject(JsonParser jsonParser, DeserializationContext context, ObjectCodec codec, JsonNode tree) throws IOException {
