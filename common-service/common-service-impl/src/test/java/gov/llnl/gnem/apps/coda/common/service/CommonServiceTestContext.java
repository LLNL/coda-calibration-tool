...
@EntityScan(basePackages = { "gov.llnl.gnem.apps.coda.common" })
@EnableJpaRepositories(basePackages = { "gov.llnl.gnem.apps.coda.common" }, repositoryBaseClass = DetachableJpaRepoImpl.class)
public class CommonServiceTestContext {
}
