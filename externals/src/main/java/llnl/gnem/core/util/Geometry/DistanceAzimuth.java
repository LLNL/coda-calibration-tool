...
{
    public DistanceAzimuth()
    {
   //     Example calls - lat1, lon1, lat2, lon2
   //     getDistanceandAzimuth(0., 0.,20., 20.);
   //     getDistAz(0.,0.,20.,20.);
   //     getDistanceandAzimuth(20.,20.,0.,0.);
   //     getDistAz(20.,20.,0.,0.);
   //     getDistanceandAzimuth(0.,0.,60.,0.);
   //     getDistAz(0.,0.,60.,0.);
   //     getDistanceandAzimuth(0.,0.,-30.,30.);
   //     getDistAz(0.,0.,-30.,30.);
   //     getDistAz(0.,0.,5.,0.);
  //      getDistAz(0.,0.,0.,5.);
     //   DirectionCosines dc = new DirectionCosines(80.,20.);
     //   System.out.println("returned: " + dc.A);
    }

    /**
        Determine Great Circle Paths, Distance, Azimuth and Back Azimuth for
    ...
    */
    public DistanceAzimuth(double latitude1, double longitude1, double latitude2, double longitude2)
    {
        ...
        //System.out.println("pt1 to east?:"+pt1_to_east);
    ...
    {
        /**
            Geometry for source-receiver paths.
            Approximates the Earth as a spheroid with a flattening, epsilon, of 0.0033528.
            convert from geographic latitude to geocentric latitude.
            From Kennett (2000) Appendix pgs 488-490 */
...
//debugging            double gclat2 = Math.atan( (0.9933056)*Math.tan(gglat2));
            ...
            //System.out.println("colatitudes:"+colat1+","+colat2);
            ...
            //System.out.println(" ");
            //System.out.println("Spheroid result:");
            //System.out.println("point 1: " + latitude1 + " " + longitude1);
            //System.out.println("point 2: " + latitude2 + " " + longitude2);
            //System.out.println("Distance: " + EpicentralDistance + " azimuth: " + azimuth + " backazimuth: " + backazimuth);
            //System.out.println("--------------------------------------------");
    ...
    double getAzimuth(SphericalDirectionCosines dc1, SphericalDirectionCosines dc2)
    {
       /** gets the azimuth from point 1 to point 2 based on direction cosines. */
            ...
            //System.out.println("arcsin(azimuth): "+Math.asin(sinAzimuth)*57.2958);
            //System.out.println("arccos(azimuth): "+Math.acos(cosAzimuth)*57.2958);
            //System.out.println("arctan(azimuth): "+Azimuth*57.2958);
