...
import llnl.gnem.core.gui.swing.plotting.VertAlignment;
...
public class DataText extends BasicText {
     ...
     * @param fontSize
     *            The size in points of the font used to render the text
     * @param textC
     *            The color of the text
     * @param hAlign
     *            The horizontal alignment of the text. For example, left,
     *            center, right
     * @param vAlign
     *            The vertical alignment of the text. For example top, center,
     *            bottom
     */
     ...
     * @param owner
     *            The JBasicPlot object to which the text belongs
     */
