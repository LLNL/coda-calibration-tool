...
import llnl.gnem.core.gui.swing.plotting.AxisScale;
import llnl.gnem.core.gui.swing.plotting.XValueMapper;
import llnl.gnem.core.gui.swing.plotting.XaxisDir;
import llnl.gnem.core.gui.swing.plotting.YValueMapper;
import llnl.gnem.core.gui.swing.plotting.YaxisDir;
...
public class CartesianTransform implements CoordinateTransform {
     ...
     * object has been set and the CartesionTransform object has been
     * initialized.
     *
     * @param v
     ...
     *
     * @param v
     *            A Coordinate object containing the point to be tested.
     * @return Returns true if the supplied coordinate has negative values and
     *         the scale type is LOG
     */
    @Override
