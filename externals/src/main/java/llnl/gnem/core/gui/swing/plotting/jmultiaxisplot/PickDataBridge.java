 ...
 * within a PickDataBridge are stored in two parts; a time and a reference time.
 * The time plus the reference time are assumed to be equal to the epoch time of
 * the pick. For plots in which the X-axis has units of epoch time, the
 * reference time is zero. For those plots in which the time has been reduced by
 * some reference time, the PickDataBridge class should be constructed with the
...
public class PickDataBridge extends Observable {
    /**
     * Constructor for the PickDataBridge objectzero. assuming a reference time
     * of zero.
     *
     * @param time
     ...
     * @param duration
     *            The duration of any associated window in seconds
     */
     ...
     *            The duration of any associated window in seconds
     * @param reftime
     *            The pick reference time in seconds.
     */
    ...
    /**
     * Sets the dirty attribute of the PickDataBridge object. When read in from
     * the database dirty is false until the window is adjusted. Newly-created
     * picks have dirty set to true.
     *
     * @param v
     *            The new dirty value
     */
    ...
    /**
     * Gets the dirty attribute of the PickDataBridge object. When read in from
     * the database dirty is false until the window is adjusted. Newly-created
     * picks have dirty set to true.
     *
     ...
     *
     * @param reftime
     *            The new reference time to assign to this PickDataBridge object
     */
    ...
    /**
     * Gets the time relative to the reference time. This is the time of the
     * pick as it is displayed in the plot.
     *
     ...
     * called by a JmultiaxisPlot's mouse motion listener in response to
     * dragging of a pick or its associated window.
     *
     * @param time
     *            The new time value
     * @param initiator
     *            A reference to the object that was being dragged.
     */
    ...
    /**
     * Sets the deltim of the PickDataBridge object. This method is expected to
     * be called by a JmultiaxisPlot's mouse motion listener in response to
     * dragging of a pick's error bars.
     *
     * @param deltim
     *            The new deltim value
     * @param initiator
     *            A reference to the object that was being dragged.
     */
