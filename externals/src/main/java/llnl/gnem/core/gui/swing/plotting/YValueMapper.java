...
public class YValueMapper {
     ...
     */
    public void setYAxisDir(final YaxisDir d) {
        theYaxisDir = d;
    }
     ...
     *            The new Scale value
     */
    public void setYScale(final AxisScale s) {
        YAxisScale = s;
    }
     ...
     */
    public void Initialize(double ymin, final double ymax, final double top, final double height) {
        ...
        Ymin = YAxisScale == AxisScale.LINEAR ? ymin : Math.log10(ymin);
        Ymax = YAxisScale == AxisScale.LINEAR ? ymax : Math.log10(ymax);
        Top = top;
        Height = height;
     ...
     */
    public double getYvalue(final double Ypixel) {
        final double result = factor2 + Ypixel / YpixelsPerDataUnit;
